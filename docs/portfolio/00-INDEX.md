...
| 类型 | 文件 | 说明 |
|---|---|---|
| 项目说明 | [熊妍-AI产品经理项目说明.pdf](project-brief/熊妍-AI产品经理项目说明.pdf) | 产品定位、用户场景、C/B 端边界、质量运营、RAG 与交付结果 |
...
建议先阅读项目说明 PDF，再结合流程图理解双端产品边界；需要追问技术实现时，可继续查看仓库中的 React、Express、MongoDB Atlas、RAG、质量评审和部署代码。
